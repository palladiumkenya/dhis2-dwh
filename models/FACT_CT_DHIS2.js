...
var FACT_CT_DHIS2 = sequelize.define(
	"FACT_CT_DHIS2",
	{
		...
		Start_ART_Under_1: { type: Sequelize.INTEGER },
		Start_ART_1_9: { type: Sequelize.INTEGER },
		Start_ART_10_14_M: { type: Sequelize.INTEGER },
		Start_ART_10_14_F: { type: Sequelize.INTEGER },
		Start_ART_15_19_M: { type: Sequelize.INTEGER },
		Start_ART_15_19_F: { type: Sequelize.INTEGER },
		Start_ART_20_24_M: { type: Sequelize.INTEGER },
		Start_ART_20_24_F: { type: Sequelize.INTEGER },
		Start_ART_25_Plus_M: { type: Sequelize.INTEGER },
		Start_ART_25_Plus_F: { type: Sequelize.INTEGER },
		On_ART_Under_1: { type: Sequelize.INTEGER },
		On_ART_1_9: { type: Sequelize.INTEGER },
		On_ART_10_14_M: { type: Sequelize.INTEGER },
		On_ART_10_14_F: { type: Sequelize.INTEGER },
		On_ART_15_19_M: { type: Sequelize.INTEGER },
		On_ART_15_19_F: { type: Sequelize.INTEGER },
		On_ART_20_24_M: { type: Sequelize.INTEGER },
		On_ART_20_24_F: { type: Sequelize.INTEGER },
		On_ART_25_Plus_M: { type: Sequelize.INTEGER },
		On_ART_25_Plus_F: { type: Sequelize.INTEGER },
	},
	{
		timestamps: true,
